...
public class MachineLevel4 {
	...
	@Test
	@FakeRandom(randomNextIntNewRandom = { 87 }, randomNextIntMethodName = { "Server.Machinery.isJunk" })
	...
	@Test
	@FakeRandom(randomNextIntNewRandom = { 88 }, randomNextIntMethodName = { "Server.Machinery.isJunk" })
